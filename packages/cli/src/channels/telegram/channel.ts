...
const TELEGRAM_COMMANDS = {
  ...
  throttle: { command: "throttle", description: "Timed summary delivery" },
  outputMode: { command: "output_mode", description: "Transcript formatting" },
  mute: { command: "mute", description: "Timed or permanent silence" },
  unmute: { command: "unmute", description: "Resume from mute" },
